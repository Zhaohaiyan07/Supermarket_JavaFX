...
public class StockOutPane {
    ...
    public Pane createPane(){
        ...
        Label inventoryLabel = new Label("请选择出库商品：");
        Label quantityLabel = new Label("请输入出库数量：");
        TextField quantityTextField = new TextField();
        Button btnSubmit = new Button("出库");
